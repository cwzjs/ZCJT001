...
namespace ZCJT.Models
{
    ...
    public class NotNullExpressionAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            ...
            return new[]{
                new ModelClientValidationRequiredRule(FormatErrorMessage(DispalyName))
            };
        }
    }
    /// <summary>
   ...
   /// <summary>
    /// [MobileNumberExpression] 验证是否为正确的手机号码
   /// </summary>
    public class MobileNumberExpressionAttribute : RegularExpressionAttribute, IClientValidatable {
        static string regStr = @"1[3|5|7|8|][0-9]{9}";
        public MobileNumberExpressionAttribute()
            : base(regStr)
        {
        ...
        {
            return String.Format(CultureInfo.CurrentCulture,
              "{0}不是正确的手机号码,如：18622222222", name);
        }

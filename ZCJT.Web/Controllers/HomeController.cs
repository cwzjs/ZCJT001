    ...
    public class HomeController : BaseController
    {
        ...
        public JsonResult GetTree(string id)
        {
            if (Session["Account"] != null)
            {
                ...
                List<SysModuleModel> menus = m_BLL.GetMenuByPersonId(account.Id, id);
                var jsonData = (
                        from m in menus
                        select new
                        {
        ...
        public JsonResult GetTreeByEasyui(string id)
        {
            ...
            if (Session["Account"] != null)
            {
                //加入本地化
                AccountModel account = (AccountModel)Session["Account"];
                List<SysModuleModel> list = m_BLL.GetMenuByPersonId(account.Id, id);
